...
description: Build 3D web apps with Three.js (WebGL/WebGPU). Use for 3D scenes, model loading, animation, physics, VR/XR, GLTF, PBR materials, particle effects, post-processing, compute shaders, TSL.
---
